...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((mod1Mask .|. shiftMask, xK_Tab   ), windows W.swapMaster)
    ...
    -- Restart xmonad
    , ((mod1Mask .|. shiftMask, xK_r     ), spawn "alacritty xmonad --recompile; xmonad --restart")
...
--
main = do
  xmproc <- spawnPipe "xmobar /home/sidney/.config/xmobar/xmobarrc"
...
help :: String
help = unlines ["The default modifier key is 'mod'. Default keybindings:",
    "",
    ...
    "alt-Shift-Tab    Swap the focused window and the master window",
